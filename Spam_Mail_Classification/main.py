...
def naivebayes():
    ...
    # the above code creates a new column and
    # apply a function to data in Category
...
def send():
    ...
    if val == 1:
        ...
        # to show a message box when the message is spam
    reset()    
